...
#  Configurando conexão com o SQL Server
...
# Endpoint que retorna todos os códigos postais
...
# Endpoint que retorna código postal específico
...
# Mensagem de erro  para quando o código postal não for encontrado
